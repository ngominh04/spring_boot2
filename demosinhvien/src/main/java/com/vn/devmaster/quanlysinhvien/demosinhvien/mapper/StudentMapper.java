...
public class StudentMapper {
    ...
    public StudentDTO toDto(Student student){
        StudentDTO studentDTO=StudentDTO.builder()
                ...
                .frist_name(student.getFirst_name())
    ...
    public  Student toEntity(StudentDTO dto){
        Student student=Student.builder()
                .id(dto.getId())
                .first_name(dto.getFrist_name()).last_name(dto.getLast_name())
                .build();
        return student;
    }
...
//    }
    ...
    public StudentDTO toDTo (Student student, StudentSubject studentSubject){
        StudentDTO studentDTO=StudentDTO.builder()
                .subjectDTOS(subjectMapper.toDto(student.getSubjects()))
                .studentSubjectDtos(studentSubjectMapper.toDto((List<StudentSubject>) studentSubject.getIdSubject()))
                .studentSubjectDtos(studentSubjectMapper.toDto((List<StudentSubject>) studentSubject.getIdStudent()))
                .frist_name(student.getFirst_name())
                .last_name(student.getLast_name())
                .id(student.getId())
                .build();
